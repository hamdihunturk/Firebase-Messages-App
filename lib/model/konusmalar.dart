...
class KonusmaModel {
  ...
  String? konusulanUserFoto;
  DateTime? sonOkunmaZamani;
  String? aradakiFark;
  KonusmaModel(this.konusma_sahibi, this.kimle_konusuyor, this.goruldu,
      this.olusturulma_tarihi, this.son_yollanan_mesaj, this.gorulme_tarihi);
  ...
  @override
  String toString() {
    return 'Konusma{konusma_sahibi: $konusma_sahibi, kimle_konusuyor: $kimle_konusuyor, goruldu: $goruldu, olusturulma_tarihi: $olusturulma_tarihi, son_yollanan_mesaj: $son_yollanan_mesaj, gorulme_tarihi: $gorulme_tarihi, ZAMANIII $sonOkunmaZamani}';
  }
}
